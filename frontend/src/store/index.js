...
//         },
//         // enter fires when a card enters a zone.
//         enter({ state, dispatch }, { userID, src, dest, target }) {
//           const self = Object.assign({}, state.boardstates[userID])
//             if (!self.User.ID) {
//                 // require a User.ID to be set or we error
//                 return dispatch('error', 'failed to find boardstate')
...
//         // leave fires when a card leaves a zone.
//         leave({ state, dispatch }, { userID, src, dest, target }) {
//         },
