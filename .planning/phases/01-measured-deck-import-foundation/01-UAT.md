...
- gap_id: G-01-1
  ...
  missing:
    ...
    - "A decision on the Moxfield stub's fate: retain as an explicitly-unverified registered host, or remove it so deckProviderAdapters lists only providers with observed contracts"
